...
public class RabbitClient {
	...
	private final static String QUEUE_NAME = "homeApp";
	private final static String RESPONSE_QUEUE_NAME = "homeAppResponse";
...
//				String randomID = jsonData.get("randomID").toString();
				...
				response = executePost("http://localhost:8080/", "SrvReq=" + message);
